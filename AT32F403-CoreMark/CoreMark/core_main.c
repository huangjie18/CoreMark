...
float CoreMark_Value = 0; //´æ´¢CoreMarkµÄÖµ
...
#error "Please define a way to initialize a memory block."
...
#if HAS_FLOAT
		if (known_id==3) {
			CoreMark_Value = default_num_contexts*results[0].iterations/time_in_secs(total_time);
	...
	GUI_DispFloatMin(CoreMark_Value,2);
