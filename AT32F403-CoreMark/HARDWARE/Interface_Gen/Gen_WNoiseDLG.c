...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
    { WINDOW_CreateIndirect, "Gen_WNoise", ID_WINDOW_0, 0, 0, 400, 240, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
    ...
    case WM_INIT_DIALOG:
        ...
        LISTBOX_AddString(hItem, "WNoise_Esc");
        LISTBOX_SetFont(hItem, GUI_FONT_20_1);  //设置字体

        //子窗口
        Gen_data.hChild = CreateSweep_Two();
    ...
    case MSG_KNOB_OUT_LEFT:
        ...
        {
            GUI_SendKeyMsg(GUI_KEY_RIGHT, 1); //滑块移
        }
    ...
    case WM_KEY:
        ...
        case GUI_KEY_ESCAPE:
            ...
            else
            {
                ...
                LISTBOX_SetSel(WM_GetDialogItem(pMsg->hWin, ID_LISTBOX_0),Gen_data.Sel); //返回列表框所选项目
            }
            break;
