...
#define ID_LISTBOX_0 (GUI_ID_USER + 0x14)
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { WINDOW_CreateIndirect, "WNoise2", ID_WINDOW_0, 0, 0, 400, 240, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    LISTBOX_AddString(hItem, "Noise2_Esc");
    LISTBOX_SetFont(hItem, GUI_FONT_20_1);
  
    Gen_data.hChild = CreateWNoise_Child1();
    ...
    case ID_LISTBOX_0: // Notifications sent by 'Listbox'
      ...
      case WM_NOTIFICATION_SEL_CHANGED:
		...
		if(Gen_data.Sel == 0)
		{
			...
			Gen_data.hChild = CreateWNoise_Child1(); //创建窗口，第一个界面
			WM_AttachWindowAt(Gen_data.hChild, pMsg->hWin, 115, 0); //把窗口加到该父窗口中
		...
		else if(Gen_data.Sel == 1)
		{
			...
			Gen_data.hChild = CreateWNoise_Child2(); //创建窗口，第一个界面
			WM_AttachWindowAt(Gen_data.hChild, pMsg->hWin, 115, 0); //把窗口加到该父窗口中
			WM_SetFocus(WM_GetDialogItem(pMsg->hWin, ID_LISTBOX_0)); //聚焦到列表框
		}
        // USER END
